...
checkpoint_dir = './Users/wonseokjung/Dropbox/11_SuperMario/tensorflow_newenv/new_env_tf_lv1'  #
train = False
retrain = True
...
output_size = 9 #up, down, left, right, run, jump
        ...
        with tf.Session(config=config) as sess:
            ...
            for episode in range(init_episode, max_episodes):
                ...
                while not done:
                  ...
                  #f  got_distance = distance-prev_distance
